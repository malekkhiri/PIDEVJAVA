...
//        return ValidationResult.fromMessageIf( control, "Username Existant", Severity.ERROR, condition );
    ...
    private void Confirmer(ActionEvent event) throws IOException, SQLException {
      ...
      //  User user = new User();
        ...
        if (LoginFXMLController.userconnecte.getActivation()==0){
       ...
       String message = String.valueOf(LoginFXMLController.userconnecte.getId());
        LoginFXMLController.userconnecte.setCodeConfirmation(Integer.parseInt(message));
