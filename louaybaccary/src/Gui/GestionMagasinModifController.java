 ...
 * @author Hosni
 */
public class GestionMagasinModifController implements Initializable {
    ...
    @FXML
    public void handleButtonConfirmer(ActionEvent event) {

        
           //esma3 l'page eli feha eli tenzel 3al'ligne bech thezlek l'item mel'table lel champs !! 
