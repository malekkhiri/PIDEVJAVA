 ...
 */
public class RegistrationVendeurFXMLController implements Initializable {
...
//        return ValidationResult.fromMessageIf( control, "Username Existant", Severity.ERROR, condition );
    ...
    private void Confirmer(ActionEvent event) throws IOException, SQLException {
        ...
        //////////////////////////////
          ...
          {
                    userconnecte = new User(textFieldUsername.getText());
        userconnecte.setNom(textFieldNom.getText());
        userconnecte.setPrenom(textFieldPrenom.getText());
        userconnecte.setUsername(textFieldUsername.getText());
        userconnecte.setEmail(textFieldEmail.getText());
        userconnecte.setPassword(textFieldPassword.getText());
        userconnecte.setNumTel(Integer.parseInt(textFieldTel.getText()));
        userconnecte.setVille(comboVille.getValue());
        userconnecte.setDateNaissance(Date.valueOf(textFieldDatenaissaince.getValue()));
       
          String message = String.valueOf(userconnecte.getUsername().hashCode());
        userconnecte.setCodeConfirmation(userconnecte.getUsername().hashCode());
        sg.creerCompteVendeur(userconnecte);
